...
Now to decode this data, we need to look at the USB specification. Specifically `usb_20.pdf, Page 262`, downloaded from the USB  Implementers Forum's website. We can find that the format looks as follows: 
...
std::ranges::copy(
    std::string_view("getvar:version"), 
    bytes.begin()
);
