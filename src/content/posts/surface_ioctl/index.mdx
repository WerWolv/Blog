...
<Figure src={import('./assets/dotPeek_namespaces.png')} alt="The namespaces of the SurfaceDTX binary in dotPeek" />
...
<Figure src={import('./assets/cheatEngine_devicePath.png')} alt="Cheat Engine" />
...
::github{repo="WerWolv/SurfaceAlwaysDTX"}