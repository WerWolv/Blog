...
This is a <PencilMarked color="orange" mode="underline">pencil underline</PencilMarked> effect. Every single one <PencilMarked mode="highlighter" color="yellow">will look different</PencilMarked>, just like if you <PencilMarked color="lightblue" mode="double-arc">would draw it by hand</PencilMarked>.
</MdxPreview>
